...
or change for perspective ADMINISTRATION -> PROJECT -> lab-project - Click on Inventory -> Route and get the correct URL for access GOGS

<ADICIONAR IMAGEM> <ROMMEL-ALTERAR>
